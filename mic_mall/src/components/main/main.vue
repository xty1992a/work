    ...
    <div class="main">
      ...
      <scroller ref="main_scroller">
        <div class="banner_img_wrap">
          ...
          <!--<img-viewer :url-list="urlList" v-if="this.headData"></img-viewer>-->
          <!--<img-viewer :url-list="urlList" v-else="this.headData"></img-viewer>-->
        </div>
...
//        console.log('token 无效')
        ...
        console.log(this.token, 'token + bid')
      }
//      this.gethead()
//      this.getList()
        ...
        axios({
          ...
          headers: {
            ...
            .then(res => {
              ...
              console.log(res.data.resultCode, 'status')
...
//        }
      ...
      setToken (bid, token) {
        if (token) { // 写
          window.localStorage['token' + bid] = token
        } else { // 读
          return window.localStorage['token' + bid]
        }
      }
    },
    computed: {
